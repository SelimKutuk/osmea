...
class ProductBrandsHandler extends ApiRequestHandler {
  String get serviceName => 'Product Brands API';

  String get serviceDescription =>
      'WooCommerce Store API for managing product brands';
  ...
  Map<String, List<ApiField>> get optionalFields => {
        'GET': [
          ...
          const ApiField(
              name: 'brand_id',
              label: 'Brand ID',
              hint: 'Specific brand ID for retrieval',
              type: ApiFieldType.number),
        ],
      };
...
- **Description**: Retrieve a specific product brand

## Parameters

- **api_version** (required): API version (e.g., v1)
- **brand_id** (optional): Brand ID for specific retrieval
...
Returns product brands with the following structure:
```json
{
  "id": 1,
  "name": "Brand Name",
    ...
    try {
      ...
      if (brandId != null) {
        ...
        final brand = await service.retrieveProductBrand(
          ...
          brandId: int.parse(brandId.toString()),
