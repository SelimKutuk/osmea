...
// /// Extension on BuildContext to easily access typography based on current theme
// extension TypographyExtension on BuildContext {
//   /// Heading styles
//   TextStyle get h1 => OsmeaTypography.h1(osmeaThemeType);
//   TextStyle get h2 => OsmeaTypography.h2(osmeaThemeType);
//   TextStyle get h3 => OsmeaTypography.h3(osmeaThemeType);
//   TextStyle get h4 => OsmeaTypography.h4(osmeaThemeType);
//   TextStyle get h5 => OsmeaTypography.h5(osmeaThemeType);
//   TextStyle get h6 => OsmeaTypography.h6(osmeaThemeType);

//   /// Body text styles
//   TextStyle get bodyLarge => OsmeaTypography.bodyLarge(osmeaThemeType);
//   TextStyle get bodyMedium => OsmeaTypography.bodyMedium(osmeaThemeType);
//   TextStyle get bodySmall => OsmeaTypography.bodySmall(osmeaThemeType);

//   /// Label styles
//   TextStyle get labelLarge => OsmeaTypography.labelLarge(osmeaThemeType);
//   TextStyle get labelMedium => OsmeaTypography.labelMedium(osmeaThemeType);
//   TextStyle get labelSmall => OsmeaTypography.labelSmall(osmeaThemeType);

//   /// Button styles
//   TextStyle get buttonLarge => OsmeaTypography.buttonLarge(osmeaThemeType);
//   TextStyle get buttonMedium => OsmeaTypography.buttonMedium(osmeaThemeType);
//   TextStyle get buttonSmall => OsmeaTypography.buttonSmall(osmeaThemeType);

//   /// Special styles
//   TextStyle get caption => OsmeaTypography.caption(osmeaThemeType);
//   TextStyle get overline => OsmeaTypography.overline(osmeaThemeType);
// }
