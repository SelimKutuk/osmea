...
abstract class UsageChargeServiceClient implements UsageChargeService {
  ...
  @factoryMethod
  factory UsageChargeServiceClient(ApiBaseClient apiClient) => _UsageChargeServiceClient(
        apiClient.starter(),
  ...
  @override
  @GET(
      '/api/{api_version}/recurring_application_charges/{recurring_application_charge_id}/usage_charges.json')
  Future<GetAllUsageChargesResponse> getUsageCharges({
    @Path('api_version') required String apiVersion,
    @Path('recurring_application_charge_id')
  ...
  @override
  @GET(
      '/api/{api_version}/recurring_application_charges/{recurring_application_charge_id}/usage_charges/{id}.json')
