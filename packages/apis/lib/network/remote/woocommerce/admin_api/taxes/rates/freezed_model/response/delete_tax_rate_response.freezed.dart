...
DeleteTaxRateResponse _$DeleteTaxRateResponseFromJson(
    Map<String, dynamic> json) {
  return _DeleteTaxRateResponse.fromJson(json);
}

/// @nodoc
mixin _$DeleteTaxRateResponse {
  @JsonKey(name: "id")
  ...
  @JsonKey(name: "class")
  String? get deleteTaxRateResponseClass => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $DeleteTaxRateResponseCopyWith<DeleteTaxRateResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DeleteTaxRateResponseCopyWith<$Res> {
  factory $DeleteTaxRateResponseCopyWith(DeleteTaxRateResponse value,
          $Res Function(DeleteTaxRateResponse) then) =
      _$DeleteTaxRateResponseCopyWithImpl<$Res, DeleteTaxRateResponse>;
  @useResult
  $Res call(
      ...
      @JsonKey(name: "class") String? deleteTaxRateResponseClass,
...
/// @nodoc
class _$DeleteTaxRateResponseCopyWithImpl<$Res,
        $Val extends DeleteTaxRateResponse>
    implements $DeleteTaxRateResponseCopyWith<$Res> {
  _$DeleteTaxRateResponseCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? deleteTaxRateResponseClass = freezed,
    ...
    return _then(_value.copyWith(
      ...
      order: freezed == order
          ...
          : order // ignore: cast_nullable_to_non_nullable
              as int?,
      deleteTaxRateResponseClass: freezed == deleteTaxRateResponseClass
          ? _value.deleteTaxRateResponseClass
          : deleteTaxRateResponseClass // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$DeleteTaxRateResponseImplCopyWith<$Res>
    implements $DeleteTaxRateResponseCopyWith<$Res> {
  factory _$$DeleteTaxRateResponseImplCopyWith(
          _$DeleteTaxRateResponseImpl value,
          $Res Function(_$DeleteTaxRateResponseImpl) then) =
      __$$DeleteTaxRateResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$DeleteTaxRateResponseImplCopyWithImpl<$Res>
    extends _$DeleteTaxRateResponseCopyWithImpl<$Res,
        _$DeleteTaxRateResponseImpl>
    implements _$$DeleteTaxRateResponseImplCopyWith<$Res> {
  __$$DeleteTaxRateResponseImplCopyWithImpl(_$DeleteTaxRateResponseImpl _value,
      $Res Function(_$DeleteTaxRateResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$DeleteTaxRateResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$DeleteTaxRateResponseImpl implements _DeleteTaxRateResponse {
  const _$DeleteTaxRateResponseImpl(
      ...
      @JsonKey(name: "class") this.deleteTaxRateResponseClass,
  ...
  factory _$DeleteTaxRateResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$DeleteTaxRateResponseImplFromJson(json);
  ...
  @override
  @JsonKey(name: "class")
  final String? deleteTaxRateResponseClass;
  ...
  @override
  String toString() {
    return 'DeleteTaxRateResponse(id: $id, country: $country, state: $state, postcode: $postcode, city: $city, rate: $rate, name: $name, priority: $priority, compound: $compound, shipping: $shipping, order: $order, deleteTaxRateResponseClass: $deleteTaxRateResponseClass, postcodes: $postcodes, cities: $cities, links: $links)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DeleteTaxRateResponseImpl &&
            ...
            (identical(other.deleteTaxRateResponseClass,
                    deleteTaxRateResponseClass) ||
                other.deleteTaxRateResponseClass ==
                    deleteTaxRateResponseClass) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DeleteTaxRateResponseImplCopyWith<_$DeleteTaxRateResponseImpl>
      get copyWith => __$$DeleteTaxRateResponseImplCopyWithImpl<
          _$DeleteTaxRateResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DeleteTaxRateResponseImplToJson(
      this,
    );
  }
}

abstract class _DeleteTaxRateResponse implements DeleteTaxRateResponse {
  const factory _DeleteTaxRateResponse(
          ...
          @JsonKey(name: "class") final String? deleteTaxRateResponseClass,
          @JsonKey(name: "postcodes") final List<String>? postcodes,
          @JsonKey(name: "cities") final List<String>? cities,
          @JsonKey(name: "_links") final Links? links}) =
      _$DeleteTaxRateResponseImpl;

  factory _DeleteTaxRateResponse.fromJson(Map<String, dynamic> json) =
      _$DeleteTaxRateResponseImpl.fromJson;
  ...
  @override
  @JsonKey(name: "class")
  String? get deleteTaxRateResponseClass;
  @override
  @JsonKey(name: "postcodes")
  List<String>? get postcodes;
  @override
