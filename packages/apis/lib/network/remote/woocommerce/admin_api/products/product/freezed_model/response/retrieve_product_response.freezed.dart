...
RetrieveProductResponse _$RetrieveProductResponseFromJson(
  ...
  return _RetrieveProductResponse.fromJson(json);
}

/// @nodoc
mixin _$RetrieveProductResponse {
  @JsonKey(name: "id")
  ...
  @JsonKey(ignore: true)
  $RetrieveProductResponseCopyWith<RetrieveProductResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $RetrieveProductResponseCopyWith<$Res> {
  factory $RetrieveProductResponseCopyWith(RetrieveProductResponse value,
          $Res Function(RetrieveProductResponse) then) =
      _$RetrieveProductResponseCopyWithImpl<$Res, RetrieveProductResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$RetrieveProductResponseCopyWithImpl<$Res,
        $Val extends RetrieveProductResponse>
    implements $RetrieveProductResponseCopyWith<$Res> {
  _$RetrieveProductResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$RetrieveProductResponseImplCopyWith<$Res>
    implements $RetrieveProductResponseCopyWith<$Res> {
  factory _$$RetrieveProductResponseImplCopyWith(
          _$RetrieveProductResponseImpl value,
          $Res Function(_$RetrieveProductResponseImpl) then) =
      __$$RetrieveProductResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$RetrieveProductResponseImplCopyWithImpl<$Res>
    extends _$RetrieveProductResponseCopyWithImpl<$Res,
        _$RetrieveProductResponseImpl>
    implements _$$RetrieveProductResponseImplCopyWith<$Res> {
  __$$RetrieveProductResponseImplCopyWithImpl(
      _$RetrieveProductResponseImpl _value,
      $Res Function(_$RetrieveProductResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$RetrieveProductResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$RetrieveProductResponseImpl implements _RetrieveProductResponse {
  const _$RetrieveProductResponseImpl(
  ...
  factory _$RetrieveProductResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$RetrieveProductResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$RetrieveProductResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$RetrieveProductResponseImplCopyWith<_$RetrieveProductResponseImpl>
      get copyWith => __$$RetrieveProductResponseImplCopyWithImpl<
          _$RetrieveProductResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$RetrieveProductResponseImplToJson(
      this,
    );
  }
}

abstract class _RetrieveProductResponse implements RetrieveProductResponse {
  const factory _RetrieveProductResponse(
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$RetrieveProductResponseImpl;

  factory _RetrieveProductResponse.fromJson(Map<String, dynamic> json) =
      _$RetrieveProductResponseImpl.fromJson;
