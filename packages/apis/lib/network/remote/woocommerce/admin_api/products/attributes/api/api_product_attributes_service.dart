...
import 'package:apis/network/remote/woocommerce/admin_api/products/attributes/freezed_model/response/list_all_product_attributes_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/products/attributes/freezed_model/response/create_product_attribute_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/products/attributes/freezed_model/response/retrieve_product_attribute_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/products/attributes/freezed_model/response/update_product_attribute_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/products/attributes/freezed_model/response/delete_product_attribute_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/products/attributes/freezed_model/request/batch_update_product_attribute_request.dart';
import 'package:apis/network/remote/woocommerce/admin_api/products/attributes/freezed_model/response/batch_update_product_attribute_response.dart';
