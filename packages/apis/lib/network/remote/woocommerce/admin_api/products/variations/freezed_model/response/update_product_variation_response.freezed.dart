...
UpdateProductVariationResponse _$UpdateProductVariationResponseFromJson(
    Map<String, dynamic> json) {
  return _UpdateProductVariationResponse.fromJson(json);
}

/// @nodoc
mixin _$UpdateProductVariationResponse {
  @JsonKey(name: "id")
  ...
  @JsonKey(ignore: true)
  $UpdateProductVariationResponseCopyWith<UpdateProductVariationResponse>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateProductVariationResponseCopyWith<$Res> {
  factory $UpdateProductVariationResponseCopyWith(
          UpdateProductVariationResponse value,
          $Res Function(UpdateProductVariationResponse) then) =
      _$UpdateProductVariationResponseCopyWithImpl<$Res,
          UpdateProductVariationResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$UpdateProductVariationResponseCopyWithImpl<$Res,
        $Val extends UpdateProductVariationResponse>
    implements $UpdateProductVariationResponseCopyWith<$Res> {
  _$UpdateProductVariationResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UpdateProductVariationResponseImplCopyWith<$Res>
    implements $UpdateProductVariationResponseCopyWith<$Res> {
  factory _$$UpdateProductVariationResponseImplCopyWith(
          _$UpdateProductVariationResponseImpl value,
          $Res Function(_$UpdateProductVariationResponseImpl) then) =
      __$$UpdateProductVariationResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "id") int? id,
...
/// @nodoc
class __$$UpdateProductVariationResponseImplCopyWithImpl<$Res>
    extends _$UpdateProductVariationResponseCopyWithImpl<$Res,
        _$UpdateProductVariationResponseImpl>
    implements _$$UpdateProductVariationResponseImplCopyWith<$Res> {
  __$$UpdateProductVariationResponseImplCopyWithImpl(
      _$UpdateProductVariationResponseImpl _value,
      $Res Function(_$UpdateProductVariationResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UpdateProductVariationResponseImpl(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$UpdateProductVariationResponseImpl
    implements _UpdateProductVariationResponse {
  const _$UpdateProductVariationResponseImpl(
  ...
  factory _$UpdateProductVariationResponseImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UpdateProductVariationResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UpdateProductVariationResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UpdateProductVariationResponseImplCopyWith<
          _$UpdateProductVariationResponseImpl>
      get copyWith => __$$UpdateProductVariationResponseImplCopyWithImpl<
          _$UpdateProductVariationResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UpdateProductVariationResponseImplToJson(
      this,
    );
  }
}

abstract class _UpdateProductVariationResponse
    implements UpdateProductVariationResponse {
  const factory _UpdateProductVariationResponse(
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$UpdateProductVariationResponseImpl;

  factory _UpdateProductVariationResponse.fromJson(Map<String, dynamic> json) =
      _$UpdateProductVariationResponseImpl.fromJson;
