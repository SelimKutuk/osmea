...
import 'package:apis/network/remote/woocommerce/admin_api/reports/freezed_model/response/list_all_reports_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/reports/freezed_model/response/retrieve_coupon_totals_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/reports/freezed_model/response/retrieve_customer_totals_response.dart';
...
import 'package:apis/network/remote/woocommerce/admin_api/reports/freezed_model/response/retrieve_product_totals_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/reports/freezed_model/response/retrieve_report_sale_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/reports/freezed_model/response/retrieve_review_totals_response.dart';
import 'package:apis/network/remote/woocommerce/admin_api/reports/freezed_model/response/retrieve_top_seller_report_response.dart';
