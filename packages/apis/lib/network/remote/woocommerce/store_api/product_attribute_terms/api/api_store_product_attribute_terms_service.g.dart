...
part of 'api_store_product_attribute_terms_service.dart';
...
class _StoreProductAttributeTermsServiceClient
    implements StoreProductAttributeTermsServiceClient {
  ...
  Future<List<ListProductAttributeTermsResponseModel>>
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<ListProductAttributeTermsResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var _value = _result.data!
        .map((dynamic i) => ListProductAttributeTermsResponseModel.fromJson(
  ...
  Future<ListProductAttributeTermsResponseModel> retrieveProductAttributeTerm({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ListProductAttributeTermsResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _value =
        ListProductAttributeTermsResponseModel.fromJson(_result.data!);
    return _value;
  }
