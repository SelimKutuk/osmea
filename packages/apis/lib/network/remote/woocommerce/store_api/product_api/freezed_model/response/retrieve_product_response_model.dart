...
RetrieveProductResponseModel retrieveProductResponseModelFromJson(String str) =>
    RetrieveProductResponseModel.fromJson(json.decode(str));

String retrieveProductResponseModelToJson(RetrieveProductResponseModel data) =>
...
class RetrieveProductResponseModel with _$RetrieveProductResponseModel {
  ...
  factory RetrieveProductResponseModel.fromJson(Map<String, dynamic> json) =>
      _$RetrieveProductResponseModelFromJson(json);
}
