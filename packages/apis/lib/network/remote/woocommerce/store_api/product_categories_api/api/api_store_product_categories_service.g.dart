...
part of 'api_store_product_categories_service.dart';
...
class _StoreProductCategoriesServiceClient
    implements StoreProductCategoriesServiceClient {
  ...
  Future<List<ListProductCategoriesResponseModel>> listProductCategories({
    ...
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<ListProductCategoriesResponseModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/wp-json/wc/store/${apiVersion}/products/categories',
    ...
    var _value = _result.data!
        .map((dynamic i) => ListProductCategoriesResponseModel.fromJson(
  ...
  Future<ListProductCategoriesResponseModel> retrieveProductCategory({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/wp-json/wc/store/${apiVersion}/products/categories/${categoryId}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
