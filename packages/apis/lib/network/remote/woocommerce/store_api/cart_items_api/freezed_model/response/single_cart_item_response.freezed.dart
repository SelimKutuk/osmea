...
part of 'single_cart_item_response.dart';
...
SingleCartItemResponse _$SingleCartItemResponseFromJson(
    Map<String, dynamic> json) {
  return _SingleCartItemResponse.fromJson(json);
}

/// @nodoc
mixin _$SingleCartItemResponse {
  @JsonKey(name: "key")
  ...
  @JsonKey(ignore: true)
  $SingleCartItemResponseCopyWith<SingleCartItemResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SingleCartItemResponseCopyWith<$Res> {
  factory $SingleCartItemResponseCopyWith(SingleCartItemResponse value,
          $Res Function(SingleCartItemResponse) then) =
      _$SingleCartItemResponseCopyWithImpl<$Res, SingleCartItemResponse>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SingleCartItemResponseCopyWithImpl<$Res,
        $Val extends SingleCartItemResponse>
    implements $SingleCartItemResponseCopyWith<$Res> {
  _$SingleCartItemResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SingleCartItemResponseImplCopyWith<$Res>
    implements $SingleCartItemResponseCopyWith<$Res> {
  factory _$$SingleCartItemResponseImplCopyWith(
          _$SingleCartItemResponseImpl value,
          $Res Function(_$SingleCartItemResponseImpl) then) =
      __$$SingleCartItemResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "key") String? key,
...
/// @nodoc
class __$$SingleCartItemResponseImplCopyWithImpl<$Res>
    extends _$SingleCartItemResponseCopyWithImpl<$Res,
        _$SingleCartItemResponseImpl>
    implements _$$SingleCartItemResponseImplCopyWith<$Res> {
  __$$SingleCartItemResponseImplCopyWithImpl(
      _$SingleCartItemResponseImpl _value,
      $Res Function(_$SingleCartItemResponseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SingleCartItemResponseImpl(
      key: freezed == key
          ? _value.key
          : key // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$SingleCartItemResponseImpl implements _SingleCartItemResponse {
  const _$SingleCartItemResponseImpl(
  ...
  factory _$SingleCartItemResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$SingleCartItemResponseImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SingleCartItemResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SingleCartItemResponseImplCopyWith<_$SingleCartItemResponseImpl>
      get copyWith => __$$SingleCartItemResponseImplCopyWithImpl<
          _$SingleCartItemResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SingleCartItemResponseImplToJson(
      this,
    );
  }
}

abstract class _SingleCartItemResponse implements SingleCartItemResponse {
  const factory _SingleCartItemResponse(
      ...
      @JsonKey(name: "_links")
      final Links? links}) = _$SingleCartItemResponseImpl;

  factory _SingleCartItemResponse.fromJson(Map<String, dynamic> json) =
      _$SingleCartItemResponseImpl.fromJson;
