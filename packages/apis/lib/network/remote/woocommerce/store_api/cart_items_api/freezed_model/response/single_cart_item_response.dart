...
//
//     final singleCartItemResponse = singleCartItemResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'single_cart_item_response.freezed.dart';
part 'single_cart_item_response.g.dart';

List<SingleCartItemResponse> singleCartItemResponseFromJson(String str) => List<SingleCartItemResponse>.from(json.decode(str).map((x) => SingleCartItemResponse.fromJson(x)));

String singleCartItemResponseToJson(List<SingleCartItemResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

@freezed
class SingleCartItemResponse with _$SingleCartItemResponse {
    const factory SingleCartItemResponse({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "_links")
        Links? links,
    }) = _SingleCartItemResponse;

    factory SingleCartItemResponse.fromJson(Map<String, dynamic> json) => _$SingleCartItemResponseFromJson(json);
}
