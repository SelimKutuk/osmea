...
ListCheckoutDataResponseModel _$ListCheckoutDataResponseModelFromJson(
    Map<String, dynamic> json) {
  return _ListCheckoutDataResponseModel.fromJson(json);
}

/// @nodoc
mixin _$ListCheckoutDataResponseModel {
  ...
  @JsonKey(ignore: true)
  $ListCheckoutDataResponseModelCopyWith<ListCheckoutDataResponseModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ListCheckoutDataResponseModelCopyWith<$Res> {
  factory $ListCheckoutDataResponseModelCopyWith(
          ListCheckoutDataResponseModel value,
          $Res Function(ListCheckoutDataResponseModel) then) =
      _$ListCheckoutDataResponseModelCopyWithImpl<$Res,
          ListCheckoutDataResponseModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$ListCheckoutDataResponseModelCopyWithImpl<$Res,
        $Val extends ListCheckoutDataResponseModel>
    implements $ListCheckoutDataResponseModelCopyWith<$Res> {
  _$ListCheckoutDataResponseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ListCheckoutDataResponseModelImplCopyWith<$Res>
    implements $ListCheckoutDataResponseModelCopyWith<$Res> {
  factory _$$ListCheckoutDataResponseModelImplCopyWith(
          _$ListCheckoutDataResponseModelImpl value,
          $Res Function(_$ListCheckoutDataResponseModelImpl) then) =
      __$$ListCheckoutDataResponseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "order_id") int? orderId,
...
/// @nodoc
class __$$ListCheckoutDataResponseModelImplCopyWithImpl<$Res>
    extends _$ListCheckoutDataResponseModelCopyWithImpl<$Res,
        _$ListCheckoutDataResponseModelImpl>
    implements _$$ListCheckoutDataResponseModelImplCopyWith<$Res> {
  __$$ListCheckoutDataResponseModelImplCopyWithImpl(
      _$ListCheckoutDataResponseModelImpl _value,
      $Res Function(_$ListCheckoutDataResponseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ListCheckoutDataResponseModelImpl(
      orderId: freezed == orderId
          ? _value.orderId
          : orderId // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$ListCheckoutDataResponseModelImpl
    implements _ListCheckoutDataResponseModel {
  const _$ListCheckoutDataResponseModelImpl(
  ...
  factory _$ListCheckoutDataResponseModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$ListCheckoutDataResponseModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ListCheckoutDataResponseModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ListCheckoutDataResponseModelImplCopyWith<
          _$ListCheckoutDataResponseModelImpl>
      get copyWith => __$$ListCheckoutDataResponseModelImplCopyWithImpl<
          _$ListCheckoutDataResponseModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ListCheckoutDataResponseModelImplToJson(
      this,
    );
  }
}

abstract class _ListCheckoutDataResponseModel
    implements ListCheckoutDataResponseModel {
  const factory _ListCheckoutDataResponseModel(
  ...
  factory _ListCheckoutDataResponseModel.fromJson(Map<String, dynamic> json) =
      _$ListCheckoutDataResponseModelImpl.fromJson;
