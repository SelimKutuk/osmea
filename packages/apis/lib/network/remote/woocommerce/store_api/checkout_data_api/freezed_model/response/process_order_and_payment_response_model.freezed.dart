...
mixin _$PaymentResult {
  ...
  List<PaymentDetail>? get paymentDetails => throw _privateConstructorUsedError;
...
abstract class $PaymentResultCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: "payment_details") List<PaymentDetail>? paymentDetails,
...
class _$PaymentDetailImpl implements _PaymentDetail {
  ...
  @override
  String toString() {
    return 'PaymentDetail(key: $key, value: $value)';
  }
...
abstract class _PaymentDetail implements PaymentDetail {
  const factory _PaymentDetail(
      ...
      @JsonKey(name: "value") final String? value}) = _$PaymentDetailImpl;
