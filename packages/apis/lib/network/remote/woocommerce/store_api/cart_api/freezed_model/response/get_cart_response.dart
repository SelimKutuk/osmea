...
class GetCartResponse with _$GetCartResponse {
    const factory GetCartResponse({
        @JsonKey(name: "items")
        List<GetCartResponseItem>? items,
        @JsonKey(name: "coupons")
        List<Coupon>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        GetCartResponseTotals? totals,
...
@freezed
class GetCartResponseItem with _$GetCartResponseItem {
    const factory GetCartResponseItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _GetCartResponseItem;

    factory GetCartResponseItem.fromJson(Map<String, dynamic> json) => _$GetCartResponseItemFromJson(json);
}
...
@freezed
class GetCartResponseShippingRate with _$GetCartResponseShippingRate {
    const factory GetCartResponseShippingRate({
    ...
    }) = _GetCartResponseShippingRate;

    factory GetCartResponseShippingRate.fromJson(Map<String, dynamic> json) => _$GetCartResponseShippingRateFromJson(json);
}
...
class ShippingRateShippingRate with _$ShippingRateShippingRate {
    ...
    factory ShippingRateShippingRate.fromJson(Map<String, dynamic> json) => _$ShippingRateShippingRateFromJson(json);
}
...
@freezed
class GetCartResponseTotals with _$GetCartResponseTotals {
    const factory GetCartResponseTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _GetCartResponseTotals;

    factory GetCartResponseTotals.fromJson(Map<String, dynamic> json) => _$GetCartResponseTotalsFromJson(json);
}
