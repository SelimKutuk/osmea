...
part 'remove_coupon_response.freezed.dart';
part 'remove_coupon_response.g.dart';
...
@freezed
class RemoveCouponResponse with _$RemoveCouponResponse {
    const factory RemoveCouponResponse({
        @JsonKey(name: "items")
        List<RemoveCouponResponseItem>? items,
        @JsonKey(name: "coupons")
        List<dynamic>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        RemoveCouponResponseTotals? totals,
    ...
    }) = _RemoveCouponResponse;

    factory RemoveCouponResponse.fromJson(Map<String, dynamic> json) => _$RemoveCouponResponseFromJson(json);
}
...
@freezed
class RemoveCouponResponseItem with _$RemoveCouponResponseItem {
    const factory RemoveCouponResponseItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _RemoveCouponResponseItem;

    factory RemoveCouponResponseItem.fromJson(Map<String, dynamic> json) => _$RemoveCouponResponseItemFromJson(json);
}
...
@freezed
class RemoveCouponResponseTotals with _$RemoveCouponResponseTotals {
    const factory RemoveCouponResponseTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _RemoveCouponResponseTotals;

    factory RemoveCouponResponseTotals.fromJson(Map<String, dynamic> json) => _$RemoveCouponResponseTotalsFromJson(json);
}
