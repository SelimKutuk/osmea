...
//
//     final selectShippingRateResponse = selectShippingRateResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'select_shipping_rate_response.freezed.dart';
part 'select_shipping_rate_response.g.dart';

SelectShippingRateResponse selectShippingRateResponseFromJson(String str) => SelectShippingRateResponse.fromJson(json.decode(str));

String selectShippingRateResponseToJson(SelectShippingRateResponse data) => json.encode(data.toJson());

@freezed
class SelectShippingRateResponse with _$SelectShippingRateResponse {
    const factory SelectShippingRateResponse({
        @JsonKey(name: "items")
        List<SelectShippingRateResponseItem>? items,
        @JsonKey(name: "coupons")
        List<Coupon>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        SelectShippingRateResponseTotals? totals,
    ...
    }) = _SelectShippingRateResponse;

    factory SelectShippingRateResponse.fromJson(Map<String, dynamic> json) => _$SelectShippingRateResponseFromJson(json);
}
...
@freezed
class SelectShippingRateResponseItem with _$SelectShippingRateResponseItem {
    const factory SelectShippingRateResponseItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _SelectShippingRateResponseItem;

    factory SelectShippingRateResponseItem.fromJson(Map<String, dynamic> json) => _$SelectShippingRateResponseItemFromJson(json);
}
...
@freezed
class SelectShippingRateResponseTotals with _$SelectShippingRateResponseTotals {
    const factory SelectShippingRateResponseTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _SelectShippingRateResponseTotals;

    factory SelectShippingRateResponseTotals.fromJson(Map<String, dynamic> json) => _$SelectShippingRateResponseTotalsFromJson(json);
}
