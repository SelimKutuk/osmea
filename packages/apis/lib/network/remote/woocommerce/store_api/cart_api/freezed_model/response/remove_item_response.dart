...
//
//     final removeItemResponse = removeItemResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'remove_item_response.freezed.dart';
part 'remove_item_response.g.dart';

RemoveItemResponse removeItemResponseFromJson(String str) => RemoveItemResponse.fromJson(json.decode(str));

String removeItemResponseToJson(RemoveItemResponse data) => json.encode(data.toJson());

@freezed
class RemoveItemResponse with _$RemoveItemResponse {
    const factory RemoveItemResponse({
        @JsonKey(name: "items")
        List<RemoveItemResponseItem>? items,
        @JsonKey(name: "coupons")
        List<dynamic>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        RemoveItemResponseTotals? totals,
    ...
    factory RemoveItemResponse.fromJson(Map<String, dynamic> json) => _$RemoveItemResponseFromJson(json);
}
...
@freezed
class RemoveItemResponseItem with _$RemoveItemResponseItem {
    const factory RemoveItemResponseItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _RemoveItemResponseItem;

    factory RemoveItemResponseItem.fromJson(Map<String, dynamic> json) => _$RemoveItemResponseItemFromJson(json);
}
...
@freezed
class RemoveItemResponseTotals with _$RemoveItemResponseTotals {
    const factory RemoveItemResponseTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _RemoveItemResponseTotals;

    factory RemoveItemResponseTotals.fromJson(Map<String, dynamic> json) => _$RemoveItemResponseTotalsFromJson(json);
}
