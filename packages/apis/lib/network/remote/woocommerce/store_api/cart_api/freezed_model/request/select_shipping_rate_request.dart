...
//
//     final selectShippingRateRequest = selectShippingRateRequestFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'select_shipping_rate_request.freezed.dart';
part 'select_shipping_rate_request.g.dart';

SelectShippingRateRequest selectShippingRateRequestFromJson(String str) => SelectShippingRateRequest.fromJson(json.decode(str));

String selectShippingRateRequestToJson(SelectShippingRateRequest data) => json.encode(data.toJson());

@freezed
class SelectShippingRateRequest with _$SelectShippingRateRequest {
    const factory SelectShippingRateRequest({
        @JsonKey(name: "items")
        List<SelectShippingRateRequestItem>? items,
        @JsonKey(name: "coupons")
        List<Coupon>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        SelectShippingRateRequestTotals? totals,
    ...
    }) = _SelectShippingRateRequest;

    factory SelectShippingRateRequest.fromJson(Map<String, dynamic> json) => _$SelectShippingRateRequestFromJson(json);
}
...
@freezed
class SelectShippingRateRequestItem with _$SelectShippingRateRequestItem {
    const factory SelectShippingRateRequestItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _SelectShippingRateRequestItem;

    factory SelectShippingRateRequestItem.fromJson(Map<String, dynamic> json) => _$SelectShippingRateRequestItemFromJson(json);
}
...
@freezed
class SelectShippingRateRequestTotals with _$SelectShippingRateRequestTotals {
    const factory SelectShippingRateRequestTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _SelectShippingRateRequestTotals;

    factory SelectShippingRateRequestTotals.fromJson(Map<String, dynamic> json) => _$SelectShippingRateRequestTotalsFromJson(json);
}
