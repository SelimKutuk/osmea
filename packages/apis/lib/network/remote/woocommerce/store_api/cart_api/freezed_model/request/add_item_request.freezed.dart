...
mixin _$AddItemRequest {
  @JsonKey(name: "items")
  List<AddItemRequestItem>? get items => throw _privateConstructorUsedError;
  ...
  @JsonKey(name: "totals")
  AddItemRequestTotals? get totals => throw _privateConstructorUsedError;
...
abstract class $AddItemRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: "items") List<AddItemRequestItem>? items,
      @JsonKey(name: "coupons") List<dynamic>? coupons,
      @JsonKey(name: "fees") List<dynamic>? fees,
      @JsonKey(name: "totals") AddItemRequestTotals? totals,
  ...
  $AddItemRequestTotalsCopyWith<$Res>? get totals;
...
class _$AddItemRequestCopyWithImpl<$Res, $Val extends AddItemRequest>
  ...
  $AddItemRequestTotalsCopyWith<$Res>? get totals {
    ...
    return $AddItemRequestTotalsCopyWith<$Res>(_value.totals!, (value) {
...
class _$AddItemRequestImpl implements _AddItemRequest {
  const _$AddItemRequestImpl(
      {@JsonKey(name: "items") final List<AddItemRequestItem>? items,
  ...
  final List<AddItemRequestItem>? _items;
  @override
  @JsonKey(name: "items")
  List<AddItemRequestItem>? get items {
    final value = _items;
  ...
  @override
  @JsonKey(name: "totals")
  final AddItemRequestTotals? totals;
  @override
  @JsonKey(name: "shipping_address")
...
abstract class _AddItemRequest implements AddItemRequest {
  const factory _AddItemRequest(
      {@JsonKey(name: "items") final List<AddItemRequestItem>? items,
      @JsonKey(name: "coupons") final List<dynamic>? coupons,
      @JsonKey(name: "fees") final List<dynamic>? fees,
      @JsonKey(name: "totals") final AddItemRequestTotals? totals,
      ...
      @JsonKey(name: "payment_methods") final List<String>? paymentMethods,
      @JsonKey(name: "extensions")
      final Extensions? extensions}) = _$AddItemRequestImpl;
  ...
  @override
  @JsonKey(name: "totals")
  AddItemRequestTotals? get totals;
  @override
  @JsonKey(name: "shipping_address")
...
AddItemRequestItem _$AddItemRequestItemFromJson(Map<String, dynamic> json) {
  return _AddItemRequestItem.fromJson(json);
}

/// @nodoc
mixin _$AddItemRequestItem {
  @JsonKey(name: "key")
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $AddItemRequestItemCopyWith<AddItemRequestItem> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AddItemRequestItemCopyWith<$Res> {
  factory $AddItemRequestItemCopyWith(
          AddItemRequestItem value, $Res Function(AddItemRequestItem) then) =
      _$AddItemRequestItemCopyWithImpl<$Res, AddItemRequestItem>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AddItemRequestItemCopyWithImpl<$Res, $Val extends AddItemRequestItem>
    implements $AddItemRequestItemCopyWith<$Res> {
  _$AddItemRequestItemCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AddItemRequestItemImplCopyWith<$Res>
    implements $AddItemRequestItemCopyWith<$Res> {
  factory _$$AddItemRequestItemImplCopyWith(_$AddItemRequestItemImpl value,
          $Res Function(_$AddItemRequestItemImpl) then) =
      __$$AddItemRequestItemImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "key") String? key,
...
/// @nodoc
class __$$AddItemRequestItemImplCopyWithImpl<$Res>
    extends _$AddItemRequestItemCopyWithImpl<$Res, _$AddItemRequestItemImpl>
    implements _$$AddItemRequestItemImplCopyWith<$Res> {
  __$$AddItemRequestItemImplCopyWithImpl(_$AddItemRequestItemImpl _value,
      $Res Function(_$AddItemRequestItemImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AddItemRequestItemImpl(
      key: freezed == key
          ? _value.key
          : key // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$AddItemRequestItemImpl implements _AddItemRequestItem {
  const _$AddItemRequestItemImpl(
  ...
  factory _$AddItemRequestItemImpl.fromJson(Map<String, dynamic> json) =>
      _$$AddItemRequestItemImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AddItemRequestItemImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AddItemRequestItemImplCopyWith<_$AddItemRequestItemImpl> get copyWith =>
      __$$AddItemRequestItemImplCopyWithImpl<_$AddItemRequestItemImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AddItemRequestItemImplToJson(
      this,
    );
  }
}

abstract class _AddItemRequestItem implements AddItemRequestItem {
  const factory _AddItemRequestItem(
      ...
      @JsonKey(name: "extensions")
      final Extensions? extensions}) = _$AddItemRequestItemImpl;

  factory _AddItemRequestItem.fromJson(Map<String, dynamic> json) =
      _$AddItemRequestItemImpl.fromJson;
...
AddItemRequestTotals _$AddItemRequestTotalsFromJson(Map<String, dynamic> json) {
  return _AddItemRequestTotals.fromJson(json);
}

/// @nodoc
mixin _$AddItemRequestTotals {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $AddItemRequestTotalsCopyWith<AddItemRequestTotals> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AddItemRequestTotalsCopyWith<$Res> {
  factory $AddItemRequestTotalsCopyWith(AddItemRequestTotals value,
          $Res Function(AddItemRequestTotals) then) =
      _$AddItemRequestTotalsCopyWithImpl<$Res, AddItemRequestTotals>;
  @useResult
  $Res call(
...
/// @nodoc
class _$AddItemRequestTotalsCopyWithImpl<$Res,
        $Val extends AddItemRequestTotals>
    implements $AddItemRequestTotalsCopyWith<$Res> {
  _$AddItemRequestTotalsCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AddItemRequestTotalsImplCopyWith<$Res>
    implements $AddItemRequestTotalsCopyWith<$Res> {
  factory _$$AddItemRequestTotalsImplCopyWith(_$AddItemRequestTotalsImpl value,
          $Res Function(_$AddItemRequestTotalsImpl) then) =
      __$$AddItemRequestTotalsImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "total_items") String? totalItems,
...
/// @nodoc
class __$$AddItemRequestTotalsImplCopyWithImpl<$Res>
    extends _$AddItemRequestTotalsCopyWithImpl<$Res, _$AddItemRequestTotalsImpl>
    implements _$$AddItemRequestTotalsImplCopyWith<$Res> {
  __$$AddItemRequestTotalsImplCopyWithImpl(_$AddItemRequestTotalsImpl _value,
      $Res Function(_$AddItemRequestTotalsImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AddItemRequestTotalsImpl(
      totalItems: freezed == totalItems
          ? _value.totalItems
          : totalItems // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$AddItemRequestTotalsImpl implements _AddItemRequestTotals {
  const _$AddItemRequestTotalsImpl(
  ...
  factory _$AddItemRequestTotalsImpl.fromJson(Map<String, dynamic> json) =>
      _$$AddItemRequestTotalsImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AddItemRequestTotalsImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AddItemRequestTotalsImplCopyWith<_$AddItemRequestTotalsImpl>
      get copyWith =>
          __$$AddItemRequestTotalsImplCopyWithImpl<_$AddItemRequestTotalsImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AddItemRequestTotalsImplToJson(
      this,
    );
  }
}

abstract class _AddItemRequestTotals implements AddItemRequestTotals {
  const factory _AddItemRequestTotals(
          ...
          @JsonKey(name: "currency_prefix") final String? currencyPrefix,
          @JsonKey(name: "currency_suffix") final String? currencySuffix}) =
      _$AddItemRequestTotalsImpl;

  factory _AddItemRequestTotals.fromJson(Map<String, dynamic> json) =
      _$AddItemRequestTotalsImpl.fromJson;
