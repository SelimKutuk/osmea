...
//
//     final updateItemResponse = updateItemResponseFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'update_item_response.freezed.dart';
part 'update_item_response.g.dart';

UpdateItemResponse updateItemResponseFromJson(String str) => UpdateItemResponse.fromJson(json.decode(str));

String updateItemResponseToJson(UpdateItemResponse data) => json.encode(data.toJson());

@freezed
class UpdateItemResponse with _$UpdateItemResponse {
    const factory UpdateItemResponse({
        @JsonKey(name: "items")
        List<UpdateItemResponseItem>? items,
        @JsonKey(name: "coupons")
        List<dynamic>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        UpdateItemResponseTotals? totals,
    ...
    factory UpdateItemResponse.fromJson(Map<String, dynamic> json) => _$UpdateItemResponseFromJson(json);
}
...
@freezed
class UpdateItemResponseItem with _$UpdateItemResponseItem {
    const factory UpdateItemResponseItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _UpdateItemResponseItem;

    factory UpdateItemResponseItem.fromJson(Map<String, dynamic> json) => _$UpdateItemResponseItemFromJson(json);
}
...
@freezed
class UpdateItemResponseTotals with _$UpdateItemResponseTotals {
    const factory UpdateItemResponseTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _UpdateItemResponseTotals;

    factory UpdateItemResponseTotals.fromJson(Map<String, dynamic> json) => _$UpdateItemResponseTotalsFromJson(json);
}
