...
//
//     final applyCouponRequest = applyCouponRequestFromJson(jsonString);
...
ApplyCouponRequest applyCouponRequestFromJson(String str) => ApplyCouponRequest.fromJson(json.decode(str));

String applyCouponRequestToJson(ApplyCouponRequest data) => json.encode(data.toJson());

@freezed
class ApplyCouponRequest with _$ApplyCouponRequest {
    const factory ApplyCouponRequest({
        @JsonKey(name: "items")
        List<ApplyCouponRequestItem>? items,
        @JsonKey(name: "coupons")
        List<Coupon>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        ApplyCouponRequestTotals? totals,
    ...
    factory ApplyCouponRequest.fromJson(Map<String, dynamic> json) => _$ApplyCouponRequestFromJson(json);
}
...
@freezed
class ApplyCouponRequestItem with _$ApplyCouponRequestItem {
    const factory ApplyCouponRequestItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _ApplyCouponRequestItem;

    factory ApplyCouponRequestItem.fromJson(Map<String, dynamic> json) => _$ApplyCouponRequestItemFromJson(json);
}
...
@freezed
class ApplyCouponRequestTotals with _$ApplyCouponRequestTotals {
    const factory ApplyCouponRequestTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _ApplyCouponRequestTotals;

    factory ApplyCouponRequestTotals.fromJson(Map<String, dynamic> json) => _$ApplyCouponRequestTotalsFromJson(json);
}
