...
//
//     final updateItemRequest = updateItemRequestFromJson(jsonString);
...
UpdateItemRequest updateItemRequestFromJson(String str) => UpdateItemRequest.fromJson(json.decode(str));

String updateItemRequestToJson(UpdateItemRequest data) => json.encode(data.toJson());

@freezed
class UpdateItemRequest with _$UpdateItemRequest {
    const factory UpdateItemRequest({
        @JsonKey(name: "items")
        List<UpdateItemRequestItem>? items,
        @JsonKey(name: "coupons")
        List<dynamic>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        UpdateItemRequestTotals? totals,
...
@freezed
class UpdateItemRequestItem with _$UpdateItemRequestItem {
    const factory UpdateItemRequestItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _UpdateItemRequestItem;

    factory UpdateItemRequestItem.fromJson(Map<String, dynamic> json) => _$UpdateItemRequestItemFromJson(json);
}
...
@freezed
class UpdateItemRequestTotals with _$UpdateItemRequestTotals {
    const factory UpdateItemRequestTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _UpdateItemRequestTotals;

    factory UpdateItemRequestTotals.fromJson(Map<String, dynamic> json) => _$UpdateItemRequestTotalsFromJson(json);
}
