...
class AddItemRequest with _$AddItemRequest {
    const factory AddItemRequest({
        @JsonKey(name: "items")
        List<AddItemRequestItem>? items,
        @JsonKey(name: "coupons")
        List<dynamic>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        AddItemRequestTotals? totals,
...
@freezed
class AddItemRequestItem with _$AddItemRequestItem {
    const factory AddItemRequestItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
    ...
    factory AddItemRequestItem.fromJson(Map<String, dynamic> json) => _$AddItemRequestItemFromJson(json);
}
...
@freezed
class AddItemRequestTotals with _$AddItemRequestTotals {
    const factory AddItemRequestTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _AddItemRequestTotals;

    factory AddItemRequestTotals.fromJson(Map<String, dynamic> json) => _$AddItemRequestTotalsFromJson(json);
}
