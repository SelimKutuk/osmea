...
part 'add_item_response.freezed.dart';
...
@freezed
class AddItemResponse with _$AddItemResponse {
    const factory AddItemResponse({
        @JsonKey(name: "items")
        List<AddItemResponseItem>? items,
        @JsonKey(name: "coupons")
        List<dynamic>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        AddItemResponseTotals? totals,
    ...
    factory AddItemResponse.fromJson(Map<String, dynamic> json) => _$AddItemResponseFromJson(json);
}
...
@freezed
class AddItemResponseItem with _$AddItemResponseItem {
    const factory AddItemResponseItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _AddItemResponseItem;

    factory AddItemResponseItem.fromJson(Map<String, dynamic> json) => _$AddItemResponseItemFromJson(json);
}
...
@freezed
class AddItemResponseTotals with _$AddItemResponseTotals {
    const factory AddItemResponseTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _AddItemResponseTotals;

    factory AddItemResponseTotals.fromJson(Map<String, dynamic> json) => _$AddItemResponseTotalsFromJson(json);
}
