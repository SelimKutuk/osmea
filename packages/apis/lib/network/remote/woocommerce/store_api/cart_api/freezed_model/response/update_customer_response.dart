...
UpdateCustomerResponse updateCustomerResponseFromJson(String str) => UpdateCustomerResponse.fromJson(json.decode(str));

String updateCustomerResponseToJson(UpdateCustomerResponse data) => json.encode(data.toJson());

@freezed
class UpdateCustomerResponse with _$UpdateCustomerResponse {
    const factory UpdateCustomerResponse({
        @JsonKey(name: "items")
        List<UpdateCustomerResponseItem>? items,
        @JsonKey(name: "coupons")
        List<Coupon>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        UpdateCustomerResponseTotals? totals,
...
@freezed
class UpdateCustomerResponseItem with _$UpdateCustomerResponseItem {
    const factory UpdateCustomerResponseItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _UpdateCustomerResponseItem;

    factory UpdateCustomerResponseItem.fromJson(Map<String, dynamic> json) => _$UpdateCustomerResponseItemFromJson(json);
}
...
@freezed
class UpdateCustomerResponseTotals with _$UpdateCustomerResponseTotals {
    const factory UpdateCustomerResponseTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _UpdateCustomerResponseTotals;

    factory UpdateCustomerResponseTotals.fromJson(Map<String, dynamic> json) => _$UpdateCustomerResponseTotalsFromJson(json);
}
