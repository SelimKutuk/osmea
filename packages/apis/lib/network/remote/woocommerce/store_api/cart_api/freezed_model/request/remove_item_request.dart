...
//
//     final removeItemRequest = removeItemRequestFromJson(jsonString);

import 'package:freezed_annotation/freezed_annotation.dart';
import 'dart:convert';

part 'remove_item_request.freezed.dart';
part 'remove_item_request.g.dart';

RemoveItemRequest removeItemRequestFromJson(String str) => RemoveItemRequest.fromJson(json.decode(str));

String removeItemRequestToJson(RemoveItemRequest data) => json.encode(data.toJson());

@freezed
class RemoveItemRequest with _$RemoveItemRequest {
    const factory RemoveItemRequest({
        @JsonKey(name: "items")
        List<RemoveItemRequestItem>? items,
        @JsonKey(name: "coupons")
        List<dynamic>? coupons,
        @JsonKey(name: "fees")
        List<dynamic>? fees,
        @JsonKey(name: "totals")
        RemoveItemRequestTotals? totals,
...
@freezed
class RemoveItemRequestItem with _$RemoveItemRequestItem {
    const factory RemoveItemRequestItem({
        @JsonKey(name: "key")
        String? key,
        @JsonKey(name: "id")
        int? id,
        ...
        @JsonKey(name: "extensions")
        Extensions? extensions,
    }) = _RemoveItemRequestItem;

    factory RemoveItemRequestItem.fromJson(Map<String, dynamic> json) => _$RemoveItemRequestItemFromJson(json);
}
...
@freezed
class RemoveItemRequestTotals with _$RemoveItemRequestTotals {
    const factory RemoveItemRequestTotals({
        ...
        @JsonKey(name: "currency_suffix")
        String? currencySuffix,
    }) = _RemoveItemRequestTotals;

    factory RemoveItemRequestTotals.fromJson(Map<String, dynamic> json) => _$RemoveItemRequestTotalsFromJson(json);
}
