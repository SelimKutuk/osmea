...
/// � **OSMEA Error Handling Enterprise Widget**
///
...
///
/// {@category Widgets}
/// {@subCategory ErrorHandlingEnterprise}

class ErrorHandlingEnterpriseWidget extends StatefulWidget {
  ...
  const ErrorHandlingEnterpriseWidget({
    super.key,
    this.onRetry,
    this.onGoHome,
  ...
  @override
  State<ErrorHandlingEnterpriseWidget> createState() =>
      _ErrorHandlingEnterpriseWidgetState();
}

class _ErrorHandlingEnterpriseWidgetState
    extends State<ErrorHandlingEnterpriseWidget> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ErrorHandlingCubit, ErrorHandlingState>(
      builder: (context, state) {
        ...
        final retryText =
            currentErrorPage?.retryButtonText ?? state.retryButtonText;
        final homeText =
            currentErrorPage?.homeButtonText ?? state.homeButtonText;
        final supportText =
            currentErrorPage?.supportButtonText ?? state.supportButtonText;
                    ...
                    child: OsmeaComponents.column(
                      ...
                      children: [
                        ...
                        OsmeaComponents.text(
                          ...
                          textStyle:
                              OsmeaTextStyle.labelMedium(context).copyWith(
                            fontWeight: FontWeight.w300,
                            height: 1.5,
                          ),
                        ),
