...
/// � **OSMEA Error Handling Space Widget**
///
...
///
/// {@category Widgets}
/// {@subCategory ErrorHandlingSpace}

class ErrorHandlingSpaceWidget extends StatefulWidget {
  ...
  const ErrorHandlingSpaceWidget({
    super.key,
    this.onRetry,
    this.onGoHome,
  ...
  @override
  State<ErrorHandlingSpaceWidget> createState() =>
      _ErrorHandlingSpaceWidgetState();
}

class _ErrorHandlingSpaceWidgetState extends State<ErrorHandlingSpaceWidget>
